package fr.aurel943.hub.scoreboard;
...
public class ScoreboardManager {
    ...
    private static final String OBJECTIVE_ID = "hub_sidebar";
    ...
    /** Recharge le fichier depuis le disque (appelé depuis Hub.reloadAllCaches()). */
    public void reload() {
        load();
